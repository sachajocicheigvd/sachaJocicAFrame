...
<template>
  ...
  >
    ...
    <a-assets @loaded="allAssetsLoaded = true">
      ...
      -->
      <a-asset-item id="room" src="assets/room/scene.gltf"></a-asset-item>
      <a-asset-item id="grenade" src="assets/grenade/scene.gltf"></a-asset-item>
      <!--
      ...
      <a-asset-item id="mine" src="assets/mine/scene.gltf"></a-asset-item>
      <a-asset-item id="zorofort" src="assets/zoro_fort/scene.gltf"></a-asset-item>
      <a-asset-item id="zorofaible" src="assets/zoro_faible/scene.gltf"></a-asset-item>
      <a-asset-item id="cage" src="assets/cage/scene.gltf"></a-asset-item>
      ...
      <img id="wood-texture" :src="`assets/wood.jpg`" >
